...
export default function Services({ onNavigate }: ServicesProps) {
  ...
  return (
    <div className="min-h-screen">
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#0a0a0a] pt-32">
        ...
        <div className="absolute top-32 right-32 w-96 h-96 bg-[#1e3a8a] rounded-full blur-[120px] opacity-15 animate-pulse"></div>
        <div className="absolute bottom-32 left-32 w-96 h-96 bg-[#2563eb] rounded-full blur-[120px] opacity-15 animate-pulse"></div>

        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
          <ScrollReveal direction="up" delay={0} depth={2}>
            <h1 className="text-6xl sm:text-7xl md:text-8xl font-black text-[#f1f5f9] mb-6 leading-tight">
          ...
          <ScrollReveal direction="up" delay={150} depth={2}>
            <p className="text-lg sm:text-xl md:text-2xl text-[#abbcd4] mb-12 max-w-3xl mx-auto leading-relaxed font-light">
